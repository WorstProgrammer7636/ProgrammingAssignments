...
public class PA4Strings {
	/**
	 * Contains string constants used in both programs of PA3 (pay attention to
	 * the comments that state which constants should be used for which program).
	 */
	

	  /* ---------------------------------------------------------------- *
	   * Use the following strings in the Radioactive Pinwheel program.
	   * ---------------------------------------------------------------- */
